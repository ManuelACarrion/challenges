...
import com.smallworldfs.challenge4.TennisGameRefactored;
...
class TennisGameTest {
    ...
    private void checkAllScores(TennisGameRefactored game, int player1Score, int player2Score, String expectedScore) {
        addPoints(game, player1Score, "Nadal");
        addPoints(game, player2Score, "Federer");

        assertThat(game.getScore()).isEqualTo(expectedScore);
    }

    private void addPoints(TennisGameRefactored game, int points, String playerName) {
    ...
    void checkAllScoresTennisGame1(int player1Score, int player2Score, String expectedScore) {
        TennisGameRefactored game = new TennisGameRefactored("Nadal", "Federer");
